...
class BoundaryDetect(wx.Frame):
    ...
    def __init__(self):
        ...
        super().__init__(parent=None, title="Mizuho_BoundaryDetect", size=(1280, 800))
        ...
        self.PlotBiPanel = wx.Panel(self.ScrollPanel, id=wx.ID_ANY, size=(600, 400), pos=(575, 80))
    ...
    def OnMouseMotion(self, event):
        ...
        if self.dragObject is not None:
            if self.dragStartPt is not None:
                ...
                #StartX = (top_left[0] - width / 2) * scaleW
                #StartY = -(top_left[1] - height / 2) * scaleH
                print(newDragPt[0]/self.scaleW+self.width/2)
                print(-(newDragPt[1] - self.height / 2)*self.scaleH)
...
if __name__ == '__main__':
    ...
    app.MainLoop()
#打包指令
#pyinstaller -w --add-data "DetectSample;DetectSample" --add-data "FullImagesSamples;FullImagesSamples" BoundaryDetect.py -n "Mizuho Analysis Tool"