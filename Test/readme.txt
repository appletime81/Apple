...
1. pyinstaller
 ...
 --- pyinstaller -w --icon "icon/launcher.ico" --add-data "icon;icon" --add-data "csv;csv" --add-data "samples;samples" --add-data "src/layout;src/layout" main.py -n "Mizuho Analysis Tool"
--- pyinstaller -w --icon "icon/launcher.ico" --add-data "icon;icon" --add-data "csv;csv" --add-data "samples;samples" --add-data "src/layout;src/layout" --add-data "DetectSample;DetectSample" --add-data "FullImagesSamples;FullImagesSamples" main.py -n "Mizuho Analysis Tool"
