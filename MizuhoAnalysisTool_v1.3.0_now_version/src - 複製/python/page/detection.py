...
class DetectionPanel(BasePanel):
    ...
    def CheckBoxAndComboBoxForSmoothFilter(self):
        self.CheckBoxUseSmoothFilter = wx.CheckBox(self.SlopeFigurePanel, id=wx.ID_ANY, label='Use SmoothFilter', pos=(50, 420))
        self.CheckBoxUseSmoothFilter.SetValue(True)
        self.ComboBoxSmoothFilter = wx.ComboBox(self.SlopeFigurePanel, id=wx.ID_ANY, value='3', choices=['3', '5', '7', '9', '11', '13', '15'], pos=(170, 417))


    def CheckBoxFor4Blocks(self):
        self.CheckBoxBlocks = wx.CheckBox(self.SlopeFigurePanel, id=wx.ID_ANY, label='4 Blocks Detection', pos=(230, 420))
    ...
    def ScrollMenu(self):
        #4Blocks選單
        self.BlockNum = wx.ComboBox(self.SlopeFigurePanel, value='4', choices=['4', '3', '2', '1'], pos=(356, 417))
        #標準差選單
